...
const PARKET_PHOTOS = (() => {
  ...
  // Pisos › Eternos (local 01, 02, 04 a 10)
  expand('Pisos › Eternos', 'pisos.html#eternos',
    i => `pisos/eternos/${String(i).padStart(2,'0')}.webp`,
    { 1:'Bambu Demolição',2:'Canela Demolição',4:'Canela Demolição',5:'Canela Demolição',
      6:'Canela Demolição',7:'Canela Demolição',8:'Canela Demolição',
      9:'Peroba Demolição',10:'Peroba Demolição' });
